...
{	
	...
	public MTMDoc(int language, int numTopics, int numVocab)
	{
		this(language, "", numTopics, numVocab);
	}
	
	public MTMDoc(int language, String document, int numTopics, int numVocab)
	{
		this.lang=language;
	...
	public MTMDoc(int language, String document, int numTopics, HashMap<String, Integer> vocabMap)
	{
		this.lang=language;
		topicCounts=new int[numTopics];
